    ...
    def _prepare_dataset(self):
        ...
        for pair in pairs:
            if len(pair) == 3:
                ...
                name1, name2, index1, index2 = \
                    pair[0], pair[0], pair[0], pair[0]
        lol = random.choice(os.listdir('/cmlscratch/dtinubu/datasets/RFW/eve_set/test/data/' + 'African' + '/' + name1 +'/'))
        imagek=os.path('/cmlscratch/dtinubu/datasets/RFW/eve_set/test/data/' + name1 + '/' + name1 +'/'+ lol)
        self.image_names_a.append(imagek)
        lol_1 = random.choice(os.listdir('/cmlscratch/dtinubu/datasets/RFW/eve_set/test/data/' + 'African' + '/' + name2 +'/'))
        imager=os.path('/cmlscratch/dtinubu/datasets/RFW/eve_set/test/data/' + name1 + '/' + name1 +'/'+ lol_1)
