...
class LFWPairedDataset(PairedDataset):
    ...
    def _prepare_dataset(self):
        ...
        for pair in pairs: 
          ...
          self.image_names_a.append(os.path.join( '/cmlscratch','dtinubu', 'datasets', 'RFW', 'eve_set', race, name1, name1+'_0000.jpg' ))
          self.image_names_b.append(os.path.join( '/cmlscratch','dtinubu','datasets','RFW', 'eve_set', race2,  name1+'_0000.jpg'))
