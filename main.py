...
def train(args):
    ...
    if args.ai != 0:
        as_training_set, as_validation_set, num_classes_as= create_datasetsAs(ars.ai,dataset_dir)
...
def evaluate(args):
    ...
    pairs_path =os.path.join('/cmlscratch','dtinubu','datasets','RFW','eve_set','test','txts' , args.pairs)
